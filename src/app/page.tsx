    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-600 via-brand-700 to-brand-900">
        <div className="text-center text-white">
          <div className="w-14 h-14 mx-auto mb-5 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
            <Sparkles className="w-8 h-8" />
          </div>
          <h1 className="text-2xl font-bold mb-2">PlanFlow</h1>
          <p className="text-brand-200 text-sm">Loading your dashboard...</p>
          <div className="w-8 h-8 mx-auto mt-6 border-3 border-white/30 border-t-white rounded-full animate-spin" />
        </div>
      </div>
    );
  }
